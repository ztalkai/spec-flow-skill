...
```bash
gh skill install ztalkai/spec-flow-skill specflow@skill-v0.1.2 --agent codex --scope user
```

With the pinned Agent Skills CLI:

```bash
npx --yes skills@1.5.23 add 'ztalkai/spec-flow-skill#skill-v0.1.2@specflow' --global --agent codex --copy --yes
```
...
```bash
gh skill install ztalkai/spec-flow-skill specflow@skill-v0.1.2 --agent claude-code --scope user
```

With the pinned Agent Skills CLI:

```bash
npx --yes skills@1.5.23 add 'ztalkai/spec-flow-skill#skill-v0.1.2@specflow' --global --agent claude-code --copy --yes
```
...
Source: `ztalkai/spec-flow@e9196607b573f842b38c1db84071237f16bfddf0`

`skill-v0.1.0` and `skill-v0.1.1` are inapplicable because they did not pass the full
